...
export function submit(data) {
  return request({ url: '/order/submit', method: 'post', data })
}

export function statusCount() {
  return request({ url: '/order/statusCount', method: 'post' })
}

export function orderDetail(orderSn) {
  return request({ url: `/order/detail/${orderSn}`, method: 'get' })
}
...
export function orderList(data) {
  return request({ url: '/order/list', method: 'get', params: data })
}
...
export function orderRefund(orderId) {
  return request({ url: `/order/refund/${orderId}`, method: 'post' })
}
